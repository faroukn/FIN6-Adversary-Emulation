...
## Project Structure ( Generated By ChatGPT)

This emulation project is organized into two primary phases, each with distinct tools, scripts, and resources. Here’s a breakdown of the files and folders included, with details on each component’s purpose.

```
FIN6-Adversary-Emulation/
├── Documentation
│   ├── fin6_emulation_outline.xlsx        # Outline of techniques used in each phase of the emulation
│   ├── OpFlow_Diagram1.png                # Operational flow diagram for phase 1
│   ├── OpFlow_Diagram.png                 # General operational flow of the FIN6 emulation
│   ├── OpFlow_Diagram2.png                # Operational flow diagram for phase 2
│   ├── phase1-1.png                       # Screenshot documenting phase 1 setup
│   ├── phase1-2.png                       # Screenshot documenting phase 1 execution
│   └── phase2.png                         # Screenshot of phase 2 operations
├── Phase1
│   ├── 7.exe                              # 7-Zip utility used for file compression in exfiltration
│   ├── AdFind.exe                         # Tool for Active Directory enumeration
│   ├── infected_word_doc.doc              # Document used in the phishing attack for initial access
│   ├── pscp.exe                           # PuTTY SCP tool for secure file transfer over SSH (optional use)
│   └── Screenshots                        # Screenshots documenting actions in phase 1
│       ├── 1.png                          # Screenshot of phase 1 initial access
│       ├── 2.png                          # Screenshot of phase 1 discovery actions
│       ├── 3.png                          # Screenshot of phase 1 privilege escalation
│       └── 4.png                          # Screenshot of phase 1 collection and exfiltration
└── Phase2
    ├── dns_c2_server.py                   # Python-based DNS C2 server script for data exfiltration
    ├── FIN6_emulation-FrameworkPOS
    │   ├── FIN6_emulation                 # Source code for the FrameworkPOS memory scraper
    │   │   ├── dllmain.cpp                # Main file of the FrameworkPOS memory scraper DLL
    │   │   ├── FIN6_emulation.h           # Header file for FrameworkPOS emulation functions
    │   │   ├── FIN6_emulation.vcxproj     # Visual Studio project file
    │   │   ├── FIN6_emulation.vcxproj.filters # Visual Studio project filters file
    │   │   └── FIN6_emulation.vcxproj.user   # User-specific Visual Studio project file
    │   ├── FIN6_emulation.sln             # Visual Studio solution file for the FrameworkPOS project
    │   ├── FIN6_emulation.suo             # Solution user options file
    │   └── Release
    │       └── FIN6_emulation.dll         # Compiled DLL of the FrameworkPOS scraper
    ├── Screenshots
    │   └── 1.png                          # Screenshot documenting actions in phase 2
    └── Simple_Victim_PoS
        ├── simple_victim_pos.cpp          # Source code for simple POS emulation
        └── simple_victim_pos.exe          # Executable for simple POS emulation
```
...
This project includes information, techniques, and procedures inspired by or directly quoted from the [Center for Threat-Informed Defense](https://ctid.mitre-engenuity.org/). Their research and documentation on adversary emulation have greatly contributed to the realism and accuracy of this FIN6 emulation project.

Special thanks to:
- [Center for Threat-Informed Defense’s research on FIN6 TTPs.](https://github.com/center-for-threat-informed-defense/adversary_emulation_library/tree/master/fin6)
- [MITRE ATT&CK framework for providing detailed mappings of adversary tactics and techniques.](https://attack.mitre.org/)
- ChatGPT
- more details, and sources are mentioned in [fin6_emulation_outline.xlsx](Documentation/fin6_emulation_outline.xlsx)
